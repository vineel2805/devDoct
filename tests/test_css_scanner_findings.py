...
def test_css_scanner_attaches_file_to_declaration_finding(tmp_path):
    ...
    assert finding.file == css_file

def test_css_scanner_attaches_file_to_rule_finding(tmp_path):
